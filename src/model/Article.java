...
public abstract class Article {
     ...
     * 
     * @param nbInStock
     *            The number of this new Article in stock.
     */
    ...
    /**
     * Sells an article. It removes an article in stock, and indicates that one
     * has been sold.
     * 
     * @throws NotAvailableException
     *             When the Article to sell is not available in stock.
     */
    ...
    /**
     * Get the total value of all sold articles.
     * 
     * @return nbSold the total value of all sold articles.
     */
