...
public class Bike extends Article {
     ...
     * how many of this Bike have been sold or are available, and then find the
     * price of the Bike.
     * 
     * @param nbInStock
     *            The number of this new Bike in stock.
     * @param brakes
     *            The Brakes model of the Bike.
     * @param fork
     *            The Fork model of the Bike.
     * @param frame
     *            The Frame model of the Bike.
     * @param suspension
     *            The Suspension model of the Bike.
     * @param wheels
     *            The Wheels model of the Bike.
     */
    public Bike(int nbInStock, Brakes brakes, Fork fork, Frame frame,
