...
/**
 * The Data class manages the shop. It controls every Article available. The
 * singleton pattern is used to ensure there is only one stock managed : the
 * current shop one.
 * 
...
public class Data {
    ...
    /**
     * The constructor of the Data class. The constructor is private to ensure
     * only one instance of the Data class will be generated.
     */
    private Data() {
        // Indicates the articles sold by the shop.
     ...
     * 
     * @param number
     *            The number of the Article in stock.
    ...
    /**
     * Method to display all informations about the stock : the available
     * components, the available articles with their price and stock
     * informations, and some money informations.
     * 
     * @return string A String about all known data.
     */
    public String toString() {
        String string = "";
        // Displays the components available regarding the articles.
        string += "Frames: ";
